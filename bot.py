...
async def handle_reply_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "সার্ভিস ক্যাটালগ" in text or text == "🚀 সার্ভিস ক্যাটালগ":
        context.user_data.pop("order_step", None)
        await show_services_msg(update, context)
        return

    if "প্রোফাইল" in text or text == "👤 প্রোফাইল ও ব্যালেন্স":
        context.user_data.pop("order_step", None)
    ...
    if "ব্যালেন্স রিচার্জ" in text or text == "💳 ব্যালেন্স রিচার্জ":
        context.user_data.pop("order_step", None)
        keyboard = [
            [
    ...
    if "হেল্পলাইন" in text or text == "💬 ২৪/৭ হেল্পলাইন":
        context.user_data.pop("order_step", None)
    ...
    if "শর্তাবলী" in text or text == "📜 শর্তাবলী ও নিয়ম":
        context.user_data.pop("order_step", None)
        terms_text = (
    ...
    if "অর্ডার ট্র্যাক" in text or text == "📍 অর্ডার ট্র্যাক করুন":
        context.user_data.pop("order_step", None)
