...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "🚀 সার্ভিস ক্যাটালগ":
        ...
        for cat in filtered_categories:
            ...
            emoji = "📁"
            if "youtube" in cat.lower(): emoji = "🔴"
            elif "facebook" in cat.lower(): emoji = "🔵"
            elif "tiktok" in cat.lower(): emoji = "🎵"
            elif "instagram" in cat.lower(): emoji = "📸"
            elif "telegram" in cat.lower(): emoji = "✈️"
            elif "traffic" in cat.lower() or "website" in cat.lower(): emoji = "🌐"
...
if __name__ == '__main__':
    ...
    if not token:
        ...
        nav_buttons_filter = filters.Regex('^(🚀 সার্ভিস ক্যাটালগ|📍 অর্ডার ট্র্যাক করুন|👤 প্রোফাইল ও ব্যালেন্স|👤 মাই প্রোফাইল|💳 ব্যালেন্স রিচার্জ|💳 টাকা জমা দিন \(রিচার্জ\)|💬 ২৪/৭ হেল্পলাইন|💬 কাস্টমার সাপোর্ট|📜 শর্তাবলী ও নিয়ম|📜 শর্তাবলী ও নিয়ম)$')
        ...
        track_conv = ConversationHandler(
            ...
            states={
                TRACK_ORDER_ID: [
                    MessageHandler(nav_buttons_filter, cancel_action),
                    MessageHandler(filters.TEXT & ~filters.COMMAND, process_track_order)
                ],
            },
            fallbacks=[
                CallbackQueryHandler(cancel_action, pattern='^cancel_flow$'),
