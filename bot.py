...
SMM_API_KEY = "622feadfdefb1016b06cc8f18cdfaf83"  # Apnar SMM Panel API Key
ADMIN_ID = 5293614793                             # Apnar Telegram User ID
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN") # Railway Environment Variable
# =============================================================
    ...
    if query.data == 'main_menu':
        ...
        if not services:
            keyboard = [[InlineKeyboardButton("🔄 পুনরায় চেষ্টা করুন", callback_data='show_all_services'),
                         InlineKeyboardButton("🏠 প্রধান মেনু", callback_data='main_menu')]]
            await query.message.edit_text("⚠️ সার্ভিস লোড হচ্ছে না! API সংযোগ পরীক্ষা করুন।", reply_markup=InlineKeyboardMarkup(keyboard))
            return
